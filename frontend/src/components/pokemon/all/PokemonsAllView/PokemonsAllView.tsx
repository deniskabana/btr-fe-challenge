...
import { SCROLL_DEBOUNCE, SCROLL_THRESHOLD } from '@/config/infiniteScroll'
...
import { PokemonsGrid } from '../../common/PokemonsGrid/PokemonsGrid'
import styles from './styles.module.scss'
import { PokemonsList } from '../../common/PokemonsList/PokemonsList'
