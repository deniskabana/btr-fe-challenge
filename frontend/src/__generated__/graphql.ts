      ...
      variableDefinitions: [
        {
          ...
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'pokemonId' } },
          type: {
            kind: 'NonNullType',
            ...
            arguments: [
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'pokemonId' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetPokemonList' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
        ...
        },
        {
          ...
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'PokemonFilterInput' },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<GetPokemonListQuery, GetPokemonListQueryVariables>
